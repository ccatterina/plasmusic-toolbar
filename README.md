...
#### 1. Install development dependencies (Debian/Ubuntu):
  ...
  ```sh
  sudo apt install qt6-declarative-dev-tools qt6-base-dev qt6-tools-dev qt6-tools-dev-tools
  ```
...
#### 2. Install the development widget:
...
#### 3. Upgrade the development widget:
...
#### 4. Restart Plasmashell to showcase the changes:
